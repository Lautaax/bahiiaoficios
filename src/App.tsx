        ...
        <div className="flex items-center gap-2">
          <Link to="/" className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <h1 className="text-lg sm:text-xl font-bold tracking-tight text-gray-900 dark:text-white leading-tight">
                Bahia Oficios
              </h1>
              <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">
          ...
          <Link
            to="/blog"
            className="hidden md:block ml-6 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
          >
            Blog y Consejos
          </Link>
        </div>
        <div className="flex items-center gap-2 sm:gap-4">
          {currentUser ? (
            <div className="flex items-center gap-2 sm:gap-4">
              <Link
                to="/dashboard"
                className="hidden md:block text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
              >
                Directorio
              </Link>
              ...
              {currentUser.isAdmin && (
                <Link
                  to="/admin"
                  className="flex items-center gap-1 text-xs sm:text-sm font-bold text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors bg-red-50 dark:bg-red-900/20 px-2 py-1 rounded-lg"
                >
                  <ShieldCheck size={16} />
            ...
            <div className="flex items-center gap-3">
              <Link
                to="/signup"
                className="hidden sm:block text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
                Soy Profesional
              </Link>
              <Link
